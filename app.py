...
with col2:
    ...
    difficulty = st.selectbox("Difficulty Level", ["Any", "Beginner", "Intermediate", "Advanced"])
    ge_area = st.selectbox("GE Area", ["Any", "Arts & Humanities", "Social Sciences", "STEM"])
    credits = st.slider("Credits", 1, 5, (1, 4))
